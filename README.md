...
Two issues were found and corrected during this project:
1. A typo referencing a non-existent table (`facilities1`) in the initial consumption query.
2. An order-of-operations bug in the solar efficiency formula that produced incorrect percentages.
